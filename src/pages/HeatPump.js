...
function HeatPump(props) {
  return (
    <div className="">
      ...
      <div className="container bglightgray borderRadiusSm shadow align itemSpacing">
        <h1 className="title text-white p-4">Geothermal Heating and Cooling</h1>
        ...
        <div class="container text-center marginTop">
          <div class="row">
            <div class="col title fs-5 text-white leftrightpadding marginTop">
